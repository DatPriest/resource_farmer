...
public sealed class PlayerInteractionComponent : Component
{
    ...
    // Schritt-f�r-Schritt-Pseudocode:
    // 1. Hole das Camera-Objekt.
    // 2. Pr�fe, ob eine Kamera vorhanden ist. Wenn nicht, Log-Warnung und return.
    ...
    // 5. F�hre den Raytrace mit origin + direction * InteractionDistance aus.
